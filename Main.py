...
Button_sprites_Red = ['Button_Red_Standart_START_512x128.png', 'Button_Red_Highlighted_START_512x128.png', 'Button_Red_Clicked_START_512x128.png']
...
Btn_Start = Button(Screen_Width / 2 - 256, Screen_Height / 2 - 64, Button_sprites_Red, 'Start', onclickFunction=Start_BtnFunc)  # MAIN BUTTON | X is {Screen_Width / 2 - <Button.width / 2>}, Y is {Screen_Width / 2 - 70}; Button.width is 280, Button.height is {Button.width / 5}
